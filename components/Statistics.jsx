                ...
                <div className="w-full space-y-10 pt-8">
                    ...
                    <div className="relative flex items-center justify-center w-full">
                        ...
                        <div className="relative bg-white px-6">
                            <span className="text-xs font-bold tracking-wider uppercase text-gray-400">
                                Partnerships With <span className="text-[#0D4E22]">Leading Brands</span>
                            </span>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-8 gap-4 w-full items-center justify-items-center">
                        {brandLogos.map((logo, index) => (
                            <div
                                key={index}
                                className="relative w-full bg-[#FAF8F5] rounded-xl p-4 flex items-center justify-center h-20 border border-gray-100 shadow-2xs hover:bg-white hover:border-gray-200 transition-colors duration-200 cursor-pointer group"
                            >
                                <Image
                                    src={logo}
                                    ...
                                    fill
                                    sizes="120px"
                                    className="max-h-10 w-auto object-contain filter grayscale opacity-60 mix-blend-multiply group-hover:opacity-100 group-hover:grayscale-0 transition-all duration-300"
                                />
                            </div>
                        ))}
                    </div>
