...
const productsData = [
  {
    ...
    desc: "High-quality, high-solubility grades perfectly suited for Indian crop cultivation and custom blending applications.",
  ...
  },
  {
    ...
    desc: "Reliable, high-purity raw materials engineered specifically for creating advanced plant growth formulations for Indian farms.",
    price: "Bulk / Quote Basis",
  ...
  },
  {
    ...
    desc: "Premium EDTA-based individual micronutrients including Zinc, Iron, Manganese, Copper, and custom specialty blends for Indian soil.",
    price: "Bulk / Quote Basis",
  ...
  },
  {
    ...
    category: "Micronutrients",
    desc: "Premium liquid nutrient solutions engineered explicitly to meet modern Indian precision agriculture requirements.",
    price: "Bulk / Quote Basis",
  ...
  },
  {
    ...
    desc: "Tailored industrial product sourcing, specialized formulation, and supply support configured to Indian agricultural business requirements.",
